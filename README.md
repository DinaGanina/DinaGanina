...
###  Обо мне:
QA-инженер. 
Ручное тестирование бэкенд-части проекта (тест-дизайн (чек-листы, тест-кейсы), тестирование сервисов REST API,  данных в БД, интеграций с веб и мобильными клиентами).
Тестирование верстки, тестирование прав доступа пользователей. 
Заведение, отслеживание, валидация и закрытие багов. 
...
### Социальные сети:
  ...
  <div id="badges">
    ...
    <a href="https://t.me/nodiqa" target="_blank">
